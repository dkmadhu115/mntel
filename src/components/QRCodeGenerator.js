...
function QRCodeGenerator() {
  ...
  const qrCodeData = JSON.stringify({companyname:"bvrit",productid:123456,productname:"student"});
  //const qrCodeData = {comapanyname:"google",proudctid:123456,productname:"iphone"};
